...
const faqs = [
  { question: "What is a modern brand name?", answer: "A modern brand name evokes feelings of modern, helping to position your business in a specific emotional or stylistic category." },
  { question: "Why choose a modern vibe?", answer: "Selecting the right vibe helps attract your target audience by setting the appropriate tone before they even see your product." }
];

export default function ModernNamesPage() {
  const staticNames = generateNames({ industry: 'tech', vibe: 'modern' as any, length: 'short', style: 'brandable', isTwoWords: false }, 12);
  const meta = buildVibeMeta(vibe);
    ...
    <>
      ...
      <main className="flex-1 flex flex-col items-center">
        <section className="w-full py-16 md:py-24 px-4 bg-muted/20 border-b">
          <div className="container max-w-4xl mx-auto text-center space-y-6">
            <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-foreground">
              Modern Brand Names – Set the Right Tone
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
              Discover modern brand names engineered for perception and trust.
            </p>
            <div className="pt-4">
              <Link href={`/?vibe=${vibe}`}>
        ...
        <section className="w-full max-w-7xl mx-auto px-4 md:px-8 py-16">
          <h2 className="text-2xl font-bold tracking-tight mb-8">Examples of Modern Brand Names</h2>
