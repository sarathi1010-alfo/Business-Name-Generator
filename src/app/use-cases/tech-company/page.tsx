...
export const metadata: Metadata = {
  title: 'Tech company Name Generator | BrandForge',
  description: 'Generate the perfect name for your tech company. Find unique, brandable ideas instantly.',
    ...
    <>
      <main className="flex-1 flex flex-col items-center">
        <section className="w-full py-16 md:py-24 px-4 bg-gradient-to-b from-background to-muted/20 border-b">
          <div className="container max-w-4xl mx-auto text-center space-y-6">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
              Looking for a unique, catchy name for your tech company? Use our AI-powered generator to find the perfect fit in seconds.
            </p>
            <div className="pt-4">
              <Link href="/">
        ...
        <section className="w-full max-w-4xl mx-auto px-4 md:px-8 py-16 prose prose-slate dark:prose-invert">
          <h2>How to choose a name for your tech company</h2>
          <p>
            The best tech company names are memorable, easy to spell, and evoke the right feeling.
