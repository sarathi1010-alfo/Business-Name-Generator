...
const faqs = [
  { question: "What is a foreign word brand name?", answer: "It involves using a word from a non-native language to evoke a specific cultural feel, elegance, or exoticism (e.g., 'Häagen-Dazs' or 'Pret A Manger')." },
  { question: "How do I choose a foreign word name?", answer: "Ensure the word doesn't have negative connotations in other major languages and is relatively easy for your target demographic to pronounce." }
];

export default function ForeignWordNamesPage() {
    ...
    <>
      ...
      <main className="flex-1 flex flex-col items-center">
        <section className="w-full py-16 md:py-24 px-4 bg-muted/20 border-b">
          <div className="container max-w-4xl mx-auto text-center space-y-6">
            <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-foreground">
              Foreign Word Brand Names – Exotic, Elegant, and Worldly
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
              Give your brand a touch of international flair by leveraging beautiful words from across the globe.
            </p>
            <div className="pt-4">
        ...
        <section className="w-full max-w-7xl mx-auto px-4 md:px-8 py-16">
          <h2 className="text-2xl font-bold tracking-tight mb-8">Global Name Inspirations</h2>
