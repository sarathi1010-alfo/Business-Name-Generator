...
export async function GET() {
  ...
  const nameStyles = ['descriptive', 'evocative', 'abstract', 'acronym', 'portmanteau', 'founder', 'compound', 'invented', 'rhyming', 'misspelled', 'historical', 'geographic', 'alliteration', 'alphanumeric', 'foreign-word', 'dictionary-word', 'mythological', 'numeric', 'hybrid', 'minimal'];
  ...
  const archetypes = ['hero', 'outlaw', 'creator', 'sage', 'magician', 'explorer', 'jester', 'lover', 'ruler', 'caregiver', 'everyman', 'innocent', 'innovator', 'guide', 'visionary', 'alchemist'];
